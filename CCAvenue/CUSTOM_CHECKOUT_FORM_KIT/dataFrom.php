...
<body>
	<div>
		<h1 style="text-align: center;">Please wait while we take you to payment gateway</h1>
	</div>
	<form hidden method="POST" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="1649624"/></td>
				</tr>
				<tr>
...
<script>
	window.onload = () => {document.forms["customerData"].submit();}
</script>
</html>
